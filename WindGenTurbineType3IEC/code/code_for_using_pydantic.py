...
class WindGenTurbineType3IEC(BaseModel):
    WindAeroLinearIEC: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be WindGenTurbineType3IEC'
    )
