...
class ExcDC3A(BaseModel):
    ...
    trh: Optional[float] = Field(
        None, description='Rheostat travel time (Trh).  Typical Value = 20. Default: 0'
    )
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be ExcDC3A')
