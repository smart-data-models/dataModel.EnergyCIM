...
class Pss1(BaseModel):
    ...
    t5: Optional[float] = Field(
        None, description='Washout (T).  Typical Value = 3.5. Default: 0'
    )
    t6: Optional[float] = Field(
        None, description='Filter time constant (T).  Typical Value = 0. Default: 0'
    )
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be Pss1')
