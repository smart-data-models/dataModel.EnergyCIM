...
class DiagramObjectPoint(BaseModel):
    DiagramObject: Optional[float] = Field(
        None,
        description='The diagram object with which the points are associated. Default: None',
    )
    DiagramObjectGluePoint: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be DiagramObjectPoint'
    )
    xPosition: Optional[float] = Field(
        None, description='The X coordinate of this point. Default: 0.0'
    )
    yPosition: Optional[float] = Field(
        None, description='The Y coordinate of this point. Default: 0.0'
    )
    zPosition: Optional[float] = Field(
        None, description='The Z coordinate of this point. Default: 0.0'
    )
