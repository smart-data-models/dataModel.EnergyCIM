...
class MutualCoupling(BaseModel):
    First_Terminal: Optional[float] = Field(
        None,
    ...
    Second_Terminal: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be MutualCoupling'
    )
