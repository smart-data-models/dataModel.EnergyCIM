...
class UnderexcLimIEEE1(BaseModel):
    ...
    kuc: Optional[float] = Field(
        None, description='UEL center setting (K).  Typical Value = 1.38. Default: 0.0'
    )
    ...
    kui: Optional[float] = Field(
        None, description='UEL integral gain (K).  Typical Value = 0. Default: 0.0'
    )
    kul: Optional[float] = Field(
        None,
        description='UEL proportional gain (K).  Typical Value = 100. Default: 0.0',
    )
    kur: Optional[float] = Field(
        None, description='UEL radius setting (K).  Typical Value = 1.95. Default: 0.0'
    )
    location: Optional[
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be UnderexcLimIEEE1'
    )
    vucmax: Optional[float] = Field(
        None,
    ...
    vuimax: Optional[float] = Field(
        None, description='UEL integrator output maximum limit (V). Default: 0.0'
    )
    vuimin: Optional[float] = Field(
        None, description='UEL integrator output minimum limit (V). Default: 0.0'
    )
