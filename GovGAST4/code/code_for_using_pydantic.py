...
class GovGAST4(BaseModel):
    ...
    ktm: Optional[float] = Field(
        None, description='Compressor gain (K).  Typical Value = 0. Default: 0.0'
    )
    location: Optional[
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be GovGAST4')
