...
class EquipmentVersion(BaseModel):
    ...
    baseURIcore: Optional[float] = Field(
        None,
    ...
    baseURIoperation: Optional[float] = Field(
        None,
        description="Profile URI used in the Model Exchange header and defined in IEC standards.  It uniquely identifies the Profile and its version. It is given for information only and to identify the closest IEC profile to which this CGMES profile is based on. Default: ''",
    )
    baseURIshortCircuit: Optional[float] = Field(
        None,
        description="Profile URI used in the Model Exchange header and defined in IEC standards.  It uniquely identifies the Profile and its version. It is given for information only and to identify the closest IEC profile to which this CGMES profile is based on. Default: ''",
    )
    ...
    entsoeURIcore: Optional[float] = Field(
        None,
    ...
    entsoeURIoperation: Optional[float] = Field(
        None,
    ...
    entsoeURIshortCircuit: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be EquipmentVersion'
    )
