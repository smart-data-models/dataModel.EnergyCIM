...
class Command(BaseModel):
    DiscreteValue: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be Command')
    value: Optional[float] = Field(
        None, description='The value representing the actuator output. Default: 0'
    )
