...
class Analog(BaseModel):
    AnalogValues: Optional[float] = Field(
        None,
        description="Measurement to which this value is connected. Default: 'list'",
    )
    LimitSets: Optional[float] = Field(
        None, description="The Measurements using the LimitSet. Default: 'list'"
    )
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be Analog')
