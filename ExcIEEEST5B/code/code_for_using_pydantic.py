...
class ExcIEEEST5B(BaseModel):
    ...
    kr: Optional[float] = Field(
        None, description='Regulator gain (K).  Typical Value = 200. Default: 0.0'
    )
    location: Optional[
    ...
    tob1: Optional[float] = Field(
        None, description='OEL lag time constant (T).  Typical Value = 2. Default: 0'
    )
    tob2: Optional[float] = Field(
        None, description='OEL lag time constant (T).  Typical Value = 0.08. Default: 0'
    )
    toc1: Optional[float] = Field(
        None, description='OEL lead time constant (T).  Typical Value = 0.1. Default: 0'
    )
    toc2: Optional[float] = Field(
        None,
        description='OEL lead time constant (T).  Typical Value = 0.08. Default: 0',
    )
    tub1: Optional[float] = Field(
        None, description='UEL lag time constant (T).  Typical Value = 10. Default: 0'
    )
    tub2: Optional[float] = Field(
        None, description='UEL lag time constant (T).  Typical Value = 0.05. Default: 0'
    )
    tuc1: Optional[float] = Field(
        None, description='UEL lead time constant (T).  Typical Value = 2. Default: 0'
    )
    tuc2: Optional[float] = Field(
        None, description='UEL lead time constant (T).  Typical Value = 0.1. Default: 0'
    )
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be ExcIEEEST5B'
    )
