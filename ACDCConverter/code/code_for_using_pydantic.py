...
class ACDCConverter(BaseModel):
    DCTerminals: Optional[float] = Field(None, description=" Default: 'list'")
    PccTerminal: Optional[float] = Field(
        None,
    ...
    baseS: Optional[float] = Field(
        None, description='Base apparent power of the converter pole. Default: 0.0'
    )
    ...
    poleLossP: Optional[float] = Field(
        None,
    ...
    switchingLoss: Optional[float] = Field(
        None,
        description='Switching losses, relative to the base apparent power `baseS`. Refer to poleLossP. Default: 0.0',
    )
    targetPpcc: Optional[float] = Field(
        None,
        description='Real power injection target in AC grid, at point of common coupling. Default: 0.0',
    )
    targetUdc: Optional[float] = Field(
        None, description='Target value for DC voltage magnitude. Default: 0.0'
    )
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be ACDCConverter'
    )
