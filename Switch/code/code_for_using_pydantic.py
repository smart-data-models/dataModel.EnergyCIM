...
class Switch(BaseModel):
    SwitchSchedules: Optional[str] = Field(
        None,
    ...
    normalOpen: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be Switch')
