...
class EnergyConsumer(BaseModel):
    ...
    pfixedPct: Optional[float] = Field(
        None,
    ...
    qfixedPct: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be EnergyConsumer'
    )
