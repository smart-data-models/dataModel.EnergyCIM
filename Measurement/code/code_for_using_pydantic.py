...
class Measurement(BaseModel):
    PowerSystemResource: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be Measurement'
    )
    unitMultiplier: Optional[float] = Field(
        None, description='The unit multiplier of the measured quantity. Default: None'
    )
    unitSymbol: Optional[float] = Field(
        None, description='The unit of measure of the measured quantity. Default: None'
    )
