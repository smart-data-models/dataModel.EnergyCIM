...
class SeriesCompensator(BaseModel):
    ...
    r: Optional[float] = Field(
        None, description='Positive sequence resistance. Default: 0.0'
    )
    r0: Optional[float] = Field(
        None, description='Zero sequence resistance. Default: 0.0'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be SeriesCompensator'
    )
    varistorPresent: Optional[float] = Field(
        None,
    ...
    x: Optional[float] = Field(
        None, description='Positive sequence reactance. Default: 0.0'
    )
    x0: Optional[float] = Field(
        None, description='Zero sequence reactance. Default: 0.0'
    )
