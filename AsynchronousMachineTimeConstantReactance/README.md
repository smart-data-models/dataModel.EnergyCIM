...
Link to the [PostgreSQL schema](https://smart-data-models.github.io/dataModel.EnergyCIM/AsynchronousMachineTimeConstantReactance/schema.sql) of this data model
### Contribution
