...
class EquivalentBranch(BaseModel):
    ...
    negativeR12: Optional[float] = Field(
        None,
    ...
    negativeR21: Optional[float] = Field(
        None,
    ...
    negativeX12: Optional[float] = Field(
        None,
    ...
    negativeX21: Optional[float] = Field(
        None,
    ...
    positiveR12: Optional[float] = Field(
        None,
    ...
    positiveR21: Optional[float] = Field(
        None,
    ...
    positiveX12: Optional[float] = Field(
        None,
    ...
    positiveX21: Optional[float] = Field(
        None,
