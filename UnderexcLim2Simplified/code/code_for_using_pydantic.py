...
class UnderexcLim2Simplified(BaseModel):
    ...
    p1: Optional[float] = Field(
        None, description='Segment P end point (P1).  Typical Value = 1. Default: 0.0'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be UnderexcLim2Simplified'
    )
    vuimax: Optional[float] = Field(
        None, description='Maximum error signal (V).  Typical Value = 1. Default: 0.0'
    )
    vuimin: Optional[float] = Field(
        None, description='Minimum error signal (V).  Typical Value = 0. Default: 0.0'
    )
