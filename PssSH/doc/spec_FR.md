...
Non disponible l'exemple d'un PssSH au format JSON-LD comme key-values. Ceci est compatible avec NGSI-LD lorsque vous utilisez `options=keyValues` et renvoie les données contextuelles d'une entité individuelle.  
