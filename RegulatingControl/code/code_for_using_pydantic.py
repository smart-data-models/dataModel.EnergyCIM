...
class RegulatingControl(BaseModel):
    ...
    enabled: Optional[float] = Field(
        None, description='The flag tells if regulation is enabled. Default: False'
    )
    id: Optional[
        Union[
            constr(
    ...
    targetValueUnitMultiplier: Optional[float] = Field(
        None,
        description='Specify the multiplier for used for the targetValue. Default: None',
    )
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be RegulatingControl'
    )
