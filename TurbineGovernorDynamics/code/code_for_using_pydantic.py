...
class TurbineGovernorDynamics(BaseModel):
    AsynchronousMachineDynamics: Optional[float] = Field(
        None,
    ...
    TurbineLoadControllerDynamics: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be TurbineGovernorDynamics'
    )
