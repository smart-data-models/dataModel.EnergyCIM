...
class ReactiveCapabilityCurve(BaseModel):
    EquivalentInjection: Optional[float] = Field(
        None,
        description="The reactive capability curve used by this equivalent injection. Default: 'list'",
    )
    InitiallyUsedBySynchronousMachines: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be ReactiveCapabilityCurve'
    )
