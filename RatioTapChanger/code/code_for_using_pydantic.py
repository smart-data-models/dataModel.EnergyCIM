...
class RatioTapChanger(BaseModel):
    RatioTapChangerTable: Optional[float] = Field(
        None, description='The ratio tap changer of this tap ratio table. Default: None'
    )
