...
class PowerTransformerEnd(BaseModel):
    PowerTransformer: Optional[float] = Field(
        None, description='The ends of this power transformer. Default: None'
    )
    ...
    b0: Optional[float] = Field(
        None, description='Zero sequence magnetizing branch susceptance. Default: 0.0'
    )
    connectionKind: Optional[float] = Field(
        None, description='Kind of connection. Default: None'
    )
    ...
    g: Optional[float] = Field(
        None, description='Magnetizing branch conductance. Default: 0.0'
    )
    ...
    phaseAngleClock: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be PowerTransformerEnd'
    )
