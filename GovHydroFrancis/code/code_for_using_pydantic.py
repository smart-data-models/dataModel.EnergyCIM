...
class GovHydroFrancis(BaseModel):
    address: Optional[Address] = Field(None, description='The mailing address')
    alternateName: Optional[str] = Field(
        None, description='An alternative name for this item'
    )
    am: Optional[float] = Field(
        None,
    ...
    kt: Optional[float] = Field(
        None, description='Washout gain (Kt).  Typical Value = 0.25. Default: 0.0'
    )
    location: Optional[
    ...
    ta: Optional[float] = Field(
        None, description='Derivative gain (Ta).  Typical Value = 3. Default: 0'
    )
    td: Optional[float] = Field(
        None, description='Washout time constant (Td).  Typical Value = 3. Default: 0'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be GovHydroFrancis'
    )
