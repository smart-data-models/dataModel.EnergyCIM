...
class OverexcLimX2(BaseModel):
    ...
    kmx: Optional[float] = Field(
        None, description='Gain (K).  Typical Value = 0.002. Default: 0.0'
    )
    location: Optional[
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be OverexcLimX2'
    )
    vlow: Optional[float] = Field(
        None, description='Low voltage limit (V) (>0). Default: 0.0'
    )
