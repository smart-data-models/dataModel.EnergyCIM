...
class TieFlow(BaseModel):
    ControlArea: Optional[float] = Field(
        None, description='The control area of the tie flows. Default: None'
    )
    Terminal: Optional[float] = Field(
        None, description='The terminal to which this tie flow belongs. Default: None'
    )
    ...
    positiveFlowIn: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be TieFlow')
