...
class Equipment(BaseModel):
    EquipmentContainer: Optional[float] = Field(
        None, description='Container of this equipment. Default: None'
    )
    ...
    aggregate: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be Equipment')
