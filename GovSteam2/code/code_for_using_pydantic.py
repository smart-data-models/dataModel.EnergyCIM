...
class GovSteam2(BaseModel):
    ...
    dbf: Optional[float] = Field(
        None, description='Frequency dead band (DBF).  Typical Value = 0. Default: 0.0'
    )
    ...
    pmax: Optional[float] = Field(
        None, description='Maximum fuel flow (P).  Typical Value = 1. Default: 0.0'
    )
    pmin: Optional[float] = Field(
        None, description='Minimum fuel flow (P).  Typical Value = 0. Default: 0.0'
    )
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be GovSteam2')
