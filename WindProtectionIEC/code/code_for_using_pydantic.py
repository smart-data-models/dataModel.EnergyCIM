...
class WindProtectionIEC(BaseModel):
    WindTurbineType1or2IEC: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be WindProtectionIEC'
    )
    uover: Optional[float] = Field(
        None,
        description='Set of wind turbine over voltage protection levels (). It is project dependent parameter. Default: 0.0',
    )
    uunder: Optional[float] = Field(
        None,
