...
class LoadResponseCharacteristic(BaseModel):
    EnergyConsumer: Optional[float] = Field(
        None,
    ...
    exponentModel: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be LoadResponseCharacteristic'
    )
