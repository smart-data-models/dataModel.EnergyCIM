...
class PFVArType1IEEEPFController(BaseModel):
    ...
    tpfc: Optional[float] = Field(
        None, description='PF controller time delay ().  Typical Value = 5. Default: 0'
    )
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be PFVArType1IEEEPFController'
    )
    vitmin: Optional[float] = Field(
        None,
        description='Minimum machine terminal current needed to enable pf/var controller (). Default: 0.0',
    )
    vpf: Optional[float] = Field(
        None, description='Synchronous machine power factor (). Default: 0.0'
    )
    vpfcbw: Optional[float] = Field(
        None,
        description='PF controller dead band ().  Typical Value = 0.05. Default: 0.0',
    )
    vpfref: Optional[float] = Field(
        None, description='PF controller reference (). Default: 0.0'
    )
    vvtmax: Optional[float] = Field(
        None,
        description='Maximum machine terminal voltage needed for pf/var controller to be enabled (). Default: 0.0',
    )
    vvtmin: Optional[float] = Field(
        None,
