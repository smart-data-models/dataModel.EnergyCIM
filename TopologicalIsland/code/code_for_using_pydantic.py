...
class TopologicalIsland(BaseModel):
    AngleRefTopologicalNode: Optional[float] = Field(
        None,
    ...
    TopologicalNodes: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be TopologicalIsland'
    )
