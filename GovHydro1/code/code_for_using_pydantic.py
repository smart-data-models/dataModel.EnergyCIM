...
class GovHydro1(BaseModel):
    ...
    at: Optional[float] = Field(
        None, description='Turbine gain (At) (>0).  Typical Value = 1.2. Default: 0.0'
    )
    ...
    rtemp: Optional[float] = Field(
        None, description='Temporary droop (r) (>R).  Typical Value = 0.3. Default: 0.0'
    )
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be GovHydro1')
