...
class GenICompensationForGenJ(BaseModel):
    ...
    VcompIEEEType2: Optional[float] = Field(
        None,
    ...
    rcij: Optional[float] = Field(None, description=' Default: 0.0')
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be GenICompensationForGenJ'
    )
    xcij: Optional[float] = Field(None, description=' Default: 0.0')
