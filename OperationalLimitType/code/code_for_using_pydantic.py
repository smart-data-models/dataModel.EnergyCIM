...
class OperationalLimitType(BaseModel):
    OperationalLimit: Optional[float] = Field(
        None,
    ...
    direction: Optional[float] = Field(
        None, description='The direction of the limit. Default: None'
    )
    id: Optional[
        Union[
            constr(
    ...
    limitType: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be OperationalLimitType'
    )
