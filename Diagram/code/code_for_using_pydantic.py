...
class Diagram(BaseModel):
    DiagramElements: Optional[float] = Field(
        None,
        description="A diagram is made up of multiple diagram objects. Default: 'list'",
    )
    DiagramStyle: Optional[float] = Field(
        None, description='A Diagram may have a DiagramStyle. Default: None'
    )
    ...
    orientation: Optional[float] = Field(
        None, description='Coordinate system orientation of the diagram. Default: None'
    )
    owner: Optional[
        List[
            Union[
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be Diagram')
