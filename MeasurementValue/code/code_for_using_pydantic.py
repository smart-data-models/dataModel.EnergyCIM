...
class MeasurementValue(BaseModel):
    MeasurementValueQuality: Optional[float] = Field(
        None,
        description='A MeasurementValue has a MeasurementValueQuality associated with it. Default: None',
    )
    MeasurementValueSource: Optional[float] = Field(
        None, description='The MeasurementValues updated by the source. Default: None'
    )
    ...
    timeStamp: Optional[float] = Field(
        None, description="The time when the value was last updated Default: ''"
    )
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be MeasurementValue'
    )
