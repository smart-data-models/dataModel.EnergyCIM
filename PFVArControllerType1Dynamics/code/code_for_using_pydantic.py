...
class PFVArControllerType1Dynamics(BaseModel):
    ...
    VoltageAdjusterDynamics: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be PFVArControllerType1Dynamics'
    )
