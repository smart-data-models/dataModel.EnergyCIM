...
Link to the [PostgreSQL schema](https://github.com/smart-data-models/dataModel.EnergyCIM/blob/master/PFVArControllerType1Dynamics/schema.sql) of this data model
### Contribution
