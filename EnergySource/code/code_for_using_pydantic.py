...
class EnergySource(BaseModel):
    EnergySchedulingType: Optional[float] = Field(
        None,
    ...
    nominalVoltage: Optional[float] = Field(
        None, description='Phase-to-phase nominal voltage. Default: 0.0'
    )
    owner: Optional[
        List[
            Union[
    ...
    r: Optional[float] = Field(
        None, description='Positive sequence Thevenin resistance. Default: 0.0'
    )
    r0: Optional[float] = Field(
        None, description='Zero sequence Thevenin resistance. Default: 0.0'
    )
    ...
    rn: Optional[float] = Field(
        None, description='Negative sequence Thevenin resistance. Default: 0.0'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be EnergySource'
    )
    voltageAngle: Optional[float] = Field(
        None, description='Phase angle of a-phase open circuit. Default: 0.0'
    )
    voltageMagnitude: Optional[float] = Field(
        None, description='Phase-to-phase open circuit voltage magnitude. Default: 0.0'
    )
    x: Optional[float] = Field(
        None, description='Positive sequence Thevenin reactance. Default: 0.0'
    )
    x0: Optional[float] = Field(
        None, description='Zero sequence Thevenin reactance. Default: 0.0'
    )
    xn: Optional[float] = Field(
        None, description='Negative sequence Thevenin reactance. Default: 0.0'
    )
