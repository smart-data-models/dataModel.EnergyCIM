...
class ExcIEEEAC8B(BaseModel):
    ...
    ka: Optional[float] = Field(
        None, description='Voltage regulator gain (K).  Typical Value = 1. Default: 0.0'
    )
    ...
    tdr: Optional[float] = Field(
        None, description='Lag time constant (T).  Typical Value = 0.1. Default: 0'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be ExcIEEEAC8B'
    )
