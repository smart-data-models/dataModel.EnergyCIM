...
class LoadGenericNonLinear(BaseModel):
    ...
    genericNonLinearLoadModelType: Optional[float] = Field(
        None, description='Type of generic non-linear load model. Default: None'
    )
    id: Optional[
        Union[
            constr(
    ...
    lt: Optional[float] = Field(
        None, description='Transient voltage index for active power (LT). Default: 0.0'
    )
    ...
    pt: Optional[float] = Field(
        None, description='Dynamic portion of active load (P). Default: 0.0'
    )
    qt: Optional[float] = Field(
        None, description='Dynamic portion of reactive load (Q). Default: 0.0'
    )
    ...
    tq: Optional[float] = Field(
        None,
        description='Time constant of lag function of reactive power (T). Default: 0',
    )
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be LoadGenericNonLinear'
    )
