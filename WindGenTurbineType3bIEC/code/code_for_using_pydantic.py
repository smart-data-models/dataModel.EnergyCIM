...
class WindGenTurbineType3bIEC(BaseModel):
    ...
    two: Optional[float] = Field(
        None,
        description='Time constant for crowbar washout filter (). It is case dependent parameter. Default: 0',
    )
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be WindGenTurbineType3bIEC'
    )
    xs: Optional[float] = Field(
        None,
