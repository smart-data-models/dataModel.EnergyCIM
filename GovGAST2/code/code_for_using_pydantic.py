...
class GovGAST2(BaseModel):
    a: Optional[float] = Field(None, description='Valve positioner (A). Default: 0.0')
    ...
    b: Optional[float] = Field(None, description='Valve positioner (B). Default: 0.0')
    ...
    c: Optional[float] = Field(None, description='Valve positioner (C). Default: 0.0')
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be GovGAST2')
    w: Optional[float] = Field(
        None, description='Governor gain (1/droop) on turbine rating (W). Default: 0.0'
    )
    x: Optional[float] = Field(
        None, description='Governor lead time constant (X). Default: 0'
    )
    y: Optional[float] = Field(
        None, description='Governor lag time constant (Y) (>0). Default: 0'
    )
    z: Optional[float] = Field(
        None, description='Governor mode (Z). true = Droop false = ISO. Default: False'
    )
