...
[사양 링크](https://github.com/smart-data-models/dataModel.EnergyCIM/blob/master/ExcitationSystemUserDefined/doc/spec_KO.md)
### Examples
...
Link to the [PostgreSQL schema](https://github.com/smart-data-models/dataModel.EnergyCIM/blob/master/ExcitationSystemUserDefined/schema.sql) of this data model
### Contribution
