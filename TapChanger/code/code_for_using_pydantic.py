...
class TapChanger(BaseModel):
    ...
    normalStep: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be TapChanger'
    )
