...
class PowerTransformer(BaseModel):
    PowerTransformerEnd: Optional[float] = Field(
        None,
    ...
    beforeShCircuitHighestOperatingCurrent: Optional[float] = Field(
        None,
    ...
    beforeShCircuitHighestOperatingVoltage: Optional[float] = Field(
        None,
    ...
    beforeShortCircuitAnglePf: Optional[float] = Field(
        None,
    ...
    highSideMinOperatingU: Optional[float] = Field(
        None,
    ...
    isPartOfGeneratorUnit: Optional[float] = Field(
        None,
    ...
    operationalValuesConsidered: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be PowerTransformer'
    )
