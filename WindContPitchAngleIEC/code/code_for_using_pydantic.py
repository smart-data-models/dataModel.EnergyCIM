...
class WindContPitchAngleIEC(BaseModel):
    ...
    ttheta: Optional[float] = Field(
        None,
        description='Pitch time constant (t). It is type dependent parameter. Default: 0',
    )
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be WindContPitchAngleIEC'
    )
