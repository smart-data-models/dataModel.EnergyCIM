...
class HydroPowerPlant(BaseModel):
    ...
    hydroPlantStorageType: Optional[float] = Field(
        None, description='The type of hydro power plant water storage. Default: None'
    )
    id: Optional[
        Union[
            constr(
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be HydroPowerPlant'
    )
