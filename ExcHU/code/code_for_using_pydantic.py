...
class ExcHU(BaseModel):
    address: Optional[Address] = Field(None, description='The mailing address')
    ae: Optional[float] = Field(
        None,
    ...
    atr: Optional[float] = Field(
        None, description='AVR constant (Atr).  Typical Value = 2.19. Default: 0.0'
    )
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be ExcHU')
