...
class VisibilityLayer(BaseModel):
    VisibleObjects: Optional[float] = Field(
        None,
    ...
    drawingOrder: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be VisibilityLayer'
    )
