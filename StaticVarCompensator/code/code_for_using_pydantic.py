...
class StaticVarCompensator(BaseModel):
    ...
    capacitiveRating: Optional[float] = Field(
        None, description='Maximum available capacitive reactance. Default: 0.0'
    )
    ...
    inductiveRating: Optional[float] = Field(
        None, description='Maximum available inductive reactance. Default: 0.0'
    )
    location: Optional[
    ...
    sVCControlMode: Optional[float] = Field(
        None, description='SVC control mode. Default: None'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be StaticVarCompensator'
    )
