...
class GovHydroDD(BaseModel):
    ...
    kg: Optional[float] = Field(
        None, description='Gate servo gain (Kg).  Typical Value = 3. Default: 0.0'
    )
    ki: Optional[float] = Field(
        None, description='Integral gain (Ki).  Typical Value = 1. Default: 0.0'
    )
    location: Optional[
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be GovHydroDD'
    )
