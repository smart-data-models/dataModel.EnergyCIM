...
class SynchronousMachineDetailed(BaseModel):
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be SynchronousMachineDetailed'
    )
