...
class PssSK(BaseModel):
    ...
    k1: Optional[float] = Field(
        None, description='Gain P (K1).  Typical Value = -0.3. Default: 0.0'
    )
    k2: Optional[float] = Field(
        None, description='Gain fe (K2).  Typical Value = -0.15. Default: 0.0'
    )
    k3: Optional[float] = Field(
        None, description='Gain If (K3).  Typical Value = 10. Default: 0.0'
    )
    location: Optional[
    ...
    t2: Optional[float] = Field(
        None, description='Filter time constant (T2).  Typical Value = 0.35. Default: 0'
    )
    ...
    t4: Optional[float] = Field(
        None, description='Filter time constant (T4).  Typical Value = 0.02. Default: 0'
    )
    ...
    t6: Optional[float] = Field(
        None, description='Filter time constant (T6).  Typical Value = 0.02. Default: 0'
    )
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be PssSK')
