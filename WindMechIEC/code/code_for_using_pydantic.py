...
class WindMechIEC(BaseModel):
    ...
    WindTurbineType4bIEC: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be WindMechIEC'
    )
