...
class GovHydroIEEE0(BaseModel):
    ...
    k: Optional[float] = Field(None, description='Governor gain (K. Default: 0.0')
    location: Optional[
    ...
    pmax: Optional[float] = Field(None, description='Gate maximum (Pmax). Default: 0.0')
    pmin: Optional[float] = Field(None, description='Gate minimum (Pmin). Default: 0.0')
    ...
    t4: Optional[float] = Field(
        None, description='Water starting time (T4). Default: 0'
    )
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be GovHydroIEEE0'
    )
