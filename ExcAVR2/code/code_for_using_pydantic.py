...
class ExcAVR2(BaseModel):
    ...
    ka: Optional[float] = Field(
        None, description='AVR gain (K).  Typical Value = 500. Default: 0.0'
    )
    kf: Optional[float] = Field(
        None, description='Rate feedback gain (K).  Typical Value = 0.02. Default: 0.0'
    )
    location: Optional[
    ...
    ta: Optional[float] = Field(
        None, description='AVR time constant (T).  Typical Value = 0.02. Default: 0'
    )
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be ExcAVR2')
    vrmn: Optional[float] = Field(
        None, description='Maximum AVR output (V).  Typical Value = -6. Default: 0.0'
    )
    vrmx: Optional[float] = Field(
        None, description='Minimum AVR output (V).  Typical Value = 7. Default: 0.0'
    )
