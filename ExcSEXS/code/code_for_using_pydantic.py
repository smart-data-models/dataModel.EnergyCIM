...
class ExcSEXS(BaseModel):
    ...
    k: Optional[float] = Field(
        None, description='Gain (K) (>0).  Typical Value = 100. Default: 0.0'
    )
    kc: Optional[float] = Field(
        None, description='PI controller gain (Kc).  Typical Value = 0.08. Default: 0.0'
    )
    location: Optional[
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be ExcSEXS')
