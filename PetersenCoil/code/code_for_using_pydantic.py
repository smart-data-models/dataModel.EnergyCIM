...
class PetersenCoil(BaseModel):
    ...
    mode: Optional[float] = Field(
        None, description='The mode of operation of the Petersen coil. Default: None'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be PetersenCoil'
    )
    xGroundMax: Optional[float] = Field(
        None, description='The maximum reactance. Default: 0.0'
    )
    xGroundMin: Optional[float] = Field(
        None, description='The minimum reactance. Default: 0.0'
    )
