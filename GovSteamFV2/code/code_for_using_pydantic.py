...
class GovSteamFV2(BaseModel):
    ...
    dt: Optional[float] = Field(None, description='(Dt). Default: 0.0')
    id: Optional[
        Union[
            constr(
                pattern=r'^[\\w\\-\\.\\{\\}\\$\\+\\*\\[\\]`|~^@!, :\\\\]+$',
    ...
    r: Optional[float] = Field(None, description='(R). Default: 0.0')
    ...
    t1: Optional[float] = Field(
        None, description='Governor time constant (T1). Default: 0'
    )
    t3: Optional[float] = Field(
        None, description='Reheater time constant (T3). Default: 0'
    )
    ta: Optional[float] = Field(
        None, description='Time after initial time for valve to close (Ta). Default: 0'
    )
    ...
    ti: Optional[float] = Field(
        None, description='Initial time to begin fast valving (Ti). Default: 0'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be GovSteamFV2'
    )
    vmax: Optional[float] = Field(None, description='(Vmax). Default: 0.0')
    vmin: Optional[float] = Field(None, description='(Vmin). Default: 0.0')
