...
class SubGeographicalRegion(BaseModel):
    DCLines: Optional[float] = Field(None, description=" Default: 'list'")
    Lines: Optional[float] = Field(
        None,
    ...
    Substations: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be SubGeographicalRegion'
    )
