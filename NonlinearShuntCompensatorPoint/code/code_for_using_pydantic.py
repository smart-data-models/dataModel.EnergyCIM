...
class NonlinearShuntCompensatorPoint(BaseModel):
    NonlinearShuntCompensator: Optional[float] = Field(
        None,
    ...
    sectionNumber: Optional[float] = Field(
        None, description='The number of the section. Default: 0'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be NonlinearShuntCompensatorPoint'
    )
