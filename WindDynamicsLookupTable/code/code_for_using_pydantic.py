...
class WindDynamicsLookupTable(BaseModel):
    ...
    input: Optional[float] = Field(
        None, description='Input value (x) for the lookup table function. Default: 0.0'
    )
    location: Optional[
    ...
    lookupTableFunctionType: Optional[float] = Field(
        None, description='Type of the lookup table function. Default: None'
    )
    name: Optional[str] = Field(None, description='The name of this item')
    output: Optional[float] = Field(
        None, description='Output value (y) for the lookup table function. Default: 0.0'
    )
    owner: Optional[
        List[
            Union[
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be WindDynamicsLookupTable'
    )
