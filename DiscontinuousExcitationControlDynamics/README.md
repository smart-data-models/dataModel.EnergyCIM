...
Link to the [PostgreSQL schema](https://smart-data-models.github.io/dataModel.EnergyCIM/DiscontinuousExcitationControlDynamics/schema.sql) of this data model
### Contribution
