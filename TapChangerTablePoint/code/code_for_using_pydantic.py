...
class TapChangerTablePoint(BaseModel):
    ...
    step: Optional[float] = Field(None, description='The tap step. Default: 0')
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be TapChangerTablePoint'
    )
