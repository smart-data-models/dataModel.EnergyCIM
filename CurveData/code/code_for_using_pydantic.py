...
class CurveData(BaseModel):
    Curve: Optional[float] = Field(
        None, description='The point data values that define this curve. Default: None'
    )
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be CurveData')
