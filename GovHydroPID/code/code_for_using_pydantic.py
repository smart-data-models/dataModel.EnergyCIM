...
class GovHydroPID(BaseModel):
    ...
    kg: Optional[float] = Field(
        None, description='Gate servo gain (Kg).  Typical Value = 2.5. Default: 0.0'
    )
    ki: Optional[float] = Field(
        None, description='Integral gain (Ki).  Typical Value = 0.36. Default: 0.0'
    )
