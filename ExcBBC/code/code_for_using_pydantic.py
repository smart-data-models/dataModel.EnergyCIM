...
class ExcBBC(BaseModel):
    ...
    k: Optional[float] = Field(
        None, description='Steady state gain (K).  Typical Value = 300. Default: 0.0'
    )
    location: Optional[
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be ExcBBC')
