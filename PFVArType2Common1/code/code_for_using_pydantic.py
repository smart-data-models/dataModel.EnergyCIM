...
class PFVArType2Common1(BaseModel):
    ...
    ki: Optional[float] = Field(None, description='Reset gain (Ki). Default: 0.0')
    kp: Optional[float] = Field(
        None, description='Proportional gain (Kp). Default: 0.0'
    )
    location: Optional[
    ...
    max: Optional[float] = Field(None, description='Output limit (max). Default: 0.0')
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be PFVArType2Common1'
    )
