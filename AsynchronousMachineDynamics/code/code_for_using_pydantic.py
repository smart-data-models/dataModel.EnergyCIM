...
class AsynchronousMachineDynamics(BaseModel):
    AsynchronousMachine: Optional[float] = Field(
        None,
    ...
    WindTurbineType1or2Dynamics: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be AsynchronousMachineDynamics'
    )
