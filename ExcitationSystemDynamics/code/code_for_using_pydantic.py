...
class ExcitationSystemDynamics(BaseModel):
    ...
    UnderexcitationLimiterDynamics: Optional[float] = Field(
        None,
        description='Undrexcitation limiter model associated with this excitation system model. Default: None',
    )
    VoltageCompensatorDynamics: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be ExcitationSystemDynamics'
    )
