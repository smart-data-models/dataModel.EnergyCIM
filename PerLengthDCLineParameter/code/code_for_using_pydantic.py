...
class PerLengthDCLineParameter(BaseModel):
    DCLineSegments: Optional[float] = Field(
        None,
    ...
    resistance: Optional[float] = Field(
        None, description='Resistance per length of the DC line segment. Default: 0.0'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be PerLengthDCLineParameter'
    )
