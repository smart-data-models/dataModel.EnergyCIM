...
class PFVArType2IEEEPFController(BaseModel):
    ...
    pfref: Optional[float] = Field(
        None, description='Power factor reference (). Default: 0.0'
    )
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be PFVArType2IEEEPFController'
    )
