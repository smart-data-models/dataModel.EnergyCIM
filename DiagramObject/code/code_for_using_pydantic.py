...
class DiagramObject(BaseModel):
    Diagram: Optional[float] = Field(
        None, description='A diagram object is part of a diagram. Default: None'
    )
    ...
    DiagramObjectStyle: Optional[float] = Field(
        None,
    ...
    isPolygon: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be DiagramObject'
    )
