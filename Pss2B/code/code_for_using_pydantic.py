...
class Pss2B(BaseModel):
    a: Optional[float] = Field(
        None, description='Numerator constant (a).  Typical Value = 1. Default: 0.0'
    )
    ...
    ta: Optional[float] = Field(
        None, description='Lead constant (Ta).  Typical Value = 0. Default: 0'
    )
    tb: Optional[float] = Field(
        None, description='Lag time constant (Tb).  Typical Value = 0. Default: 0'
    )
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be Pss2B')
