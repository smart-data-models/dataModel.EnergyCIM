...
class GovSteam0(BaseModel):
    ...
    t3: Optional[float] = Field(
        None, description='Reheater time constant (T3).  Typical Value = 10. Default: 0'
    )
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be GovSteam0')
