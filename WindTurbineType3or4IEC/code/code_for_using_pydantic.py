...
class WindTurbineType3or4IEC(BaseModel):
    WIndContQIEC: Optional[float] = Field(
        None,
    ...
    WindProtectionIEC: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be WindTurbineType3or4IEC'
    )
