...
class BaseVoltage(BaseModel):
    ...
    TopologicalNode: Optional[float] = Field(
        None, description="The topological nodes at the base voltage. Default: 'list'"
    )
    TransformerEnds: Optional[float] = Field(
        None,
        description="Transformer ends at the base voltage.  This is essential for PU calculation. Default: 'list'",
    )
    VoltageLevel: Optional[float] = Field(
        None, description="The voltage levels having this base voltage. Default: 'list'"
    )
    ...
    nominalVoltage: Optional[float] = Field(
        None, description='The power system resource`s base voltage. Default: 0.0'
    )
    owner: Optional[
        List[
            Union[
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be BaseVoltage'
    )
