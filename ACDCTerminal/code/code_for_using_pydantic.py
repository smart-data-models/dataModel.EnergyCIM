...
class ACDCTerminal(BaseModel):
    BusNameMarker: Optional[float] = Field(
        None,
        description='The bus name marker used to name the bus (topological node). Default: None',
    )
    Measurements: Optional[float] = Field(
        None,
    ...
    OperationalLimitSet: Optional[float] = Field(None, description=" Default: 'list'")
    ...
    connected: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be ACDCTerminal'
    )
