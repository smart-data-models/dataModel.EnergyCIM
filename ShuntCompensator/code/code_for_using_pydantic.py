...
class ShuntCompensator(BaseModel):
    SvShuntCompensatorSections: Optional[float] = Field(
        None,
    ...
    maximumSections: Optional[float] = Field(
        None,
    ...
    normalSections: Optional[float] = Field(
        None, description='The normal number of sections switched in. Default: 0'
    )
    owner: Optional[
        List[
            Union[
