...
class GovHydro2(BaseModel):
    ...
    pmin: Optional[float] = Field(
        None, description='Minimum gate opening; ().  Typical Value = 0. Default: 0.0'
    )
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be GovHydro2')
