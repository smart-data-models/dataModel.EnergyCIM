...
class IdentifiedObject(BaseModel):
    DiagramObjects: Optional[float] = Field(
        None,
    ...
    energyIdentCodeEic: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be IdentifiedObject'
    )
