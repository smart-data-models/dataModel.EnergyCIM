...
class FossilFuel(BaseModel):
    ThermalGeneratingUnit: Optional[float] = Field(
        None,
    ...
    fossilFuelType: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be FossilFuel'
    )
