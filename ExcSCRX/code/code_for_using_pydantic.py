...
class ExcSCRX(BaseModel):
    ...
    k: Optional[float] = Field(
        None, description='Gain (K) (>0).  Typical Value = 200. Default: 0.0'
    )
    location: Optional[
    ...
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be ExcSCRX')
