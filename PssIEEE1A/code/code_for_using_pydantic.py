...
class PssIEEE1A(BaseModel):
    ...
    ks: Optional[float] = Field(
        None, description='Stabilizer gain (Ks).  Typical Value = 5. Default: 0.0'
    )
    location: Optional[
    ...
    t5: Optional[float] = Field(
        None, description='Washout time constant (T5).  Typical Value = 10. Default: 0'
    )
    t6: Optional[float] = Field(
        None,
        description='Transducer time constant (T6).  Typical Value = 0.01. Default: 0',
    )
    type: Optional[Type6] = Field(None, description='NGSI type. It has to be PssIEEE1A')
