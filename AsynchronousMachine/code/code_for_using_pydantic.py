...
class AsynchronousMachine(BaseModel):
    ...
    polePairNumber: Optional[float] = Field(
        None,
    ...
    reversible: Optional[float] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be AsynchronousMachine'
    )
