...
class RegularIntervalSchedule(BaseModel):
    TimePoints: Optional[float] = Field(
        None,
    ...
    endTime: Optional[float] = Field(
        None, description="The time for the last time point. Default: ''"
    )
    id: Optional[
        Union[
            constr(
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI type. It has to be RegularIntervalSchedule'
    )
